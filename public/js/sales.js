...
$(document).ready(function () {
  ...
  $('.btn-details').on('click', function (e) {
    ...
    var newTable = $("<tr>");
    var row = '<td name="item_code">' + data.item_code + '</td><td>' + data.item_name + '</td><td name="item_price">' + data.item_price + '</td><td><input type="text" value="0" name="item_discount"></td><td name="itemquan"><input type="number" name="item_quantity" value="1"></td><td name="item_total" style="color: red;">' + data.item_price + '</td></tr>';
    newTable.append(row);
