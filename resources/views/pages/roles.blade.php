                        ...
                        <div class="card my-4">
                            ...
                            <div class="modal-dialog modal-lg " role="document">
                                ...
                                <div class="modal-header bg-gradient-dark shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="modal-title text-white" id="largeModalLabel">Add New Role</h6>
                                </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <a href="{{ route('delete-roles', ['id' => $role->id]) }}" class="btn btn-danger btn-link delete-link" data-original-title="" title="">
